...
var renderTableInOutputChannel = __webpack_require__(2);
var fzCalculator = __webpack_require__(3);
...
function loadFileInfoAsync(filepath) {
  fs = fs || self.BrowserFS.BFSRequire('fs');
...
function addMimeTypeInfo(info) {
  mime = mime || __webpack_require__(41);
...
function addImageInfo(info) {
  ...
  imageSize = imageSize || __webpack_require__(45);
...
function addPrettyDateInfo(info, options) {
  ...
  moment = moment || __webpack_require__(63);
  return assign(info, {
...
function addGzipSize(info, options) {
  ...
  gzipSize = gzipSize || __webpack_require__(193);
...
module.exports = new Mime(__webpack_require__(43), __webpack_require__(44));
...
var typeHandlers = __webpack_require__(48);
var detector = __webpack_require__(62);
...
var typeHandlers = {
  bmp: __webpack_require__(49),
  cur: __webpack_require__(50),
  dds: __webpack_require__(52),
  gif: __webpack_require__(53),
  icns: __webpack_require__(54),
  ico: __webpack_require__(51),
  jpg: __webpack_require__(55),
  png: __webpack_require__(56),
  psd: __webpack_require__(57),
  svg: __webpack_require__(58),
  tiff: __webpack_require__(59),
  webp: __webpack_require__(61),
};
...
module.exports = {
  'detect': isCUR,
  'calculate': __webpack_require__(51).calculate
};
...
var fs = __webpack_require__(46);
var readUInt = __webpack_require__(60);
...
const stream = __webpack_require__(194);
const zlib = __webpack_require__(195);
const duplexer = __webpack_require__(196);
const pify = __webpack_require__(197);
